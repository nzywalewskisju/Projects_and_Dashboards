# About Me
Hello, and welcome to my portfolio! My name is Nick Zywalewski, and I am currently a senior at Saint Joseph's University in Philadelphia, PA. I study Data Science, Business Intelligence & Analytics, and Mathematics!
<br><br>I have experience with several coding languages: Python, R, MySQL/SQL, Java, JavaScript, VBA, and HTML/CSS. I am also skilled in other areas that aid in data analysis: Tableau, Alteryx, JMP, Salesforce, and Excel.
<br><br>I have honed these skills in my classwork and in my industry experiences with Susquehanna International Group, Comcast Spectacor/Philadelphia Flyers, and Keystone Technologies. Upon graduation, I will be working at Johnson & Johnson as an Innovative Medicine Quality Strategy & Deployment Support Analyst through the Global Operations Leadership Development Program.
...
- Handled missing values with K-Nearest Neighbors imputation  
...
### [Tableau Dashboards](Tableau_Dashboards/) **[Tableau]**
- Created interactive visual dashboards in Tableau covering business intelligence, sports analytics, and data storytelling  
...
### [Cluster Analysis of U.S. State Crime Data](R_Cluster_Analysis_Crime_Data/) **[R]**
- Performed a k-means clustering study in R using state-level crime statistics  
...
### [Airline Tweets Classification Project](Text_Classification_NN/) **[Python]**
- Trained two neural networks in Python (LSTM and CNN) to classify tweets about U.S. airlines  
...
### [Predicting Phillies Wins using MLR Model](Predicting_Phillies_Wins/) **[Python]**
