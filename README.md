...
- Built a deep learning model to estimate baseball exit velocity using swing and pitch data
...
- Simulated a hospital delivery robot navigating between wards using graph search algorithms  
